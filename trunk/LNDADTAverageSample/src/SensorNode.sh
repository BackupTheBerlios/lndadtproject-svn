...
echo "Starting sensorApp.SensorNode, check LogNormal.txt and LogErrors.txt"
echo "Press Ctrl+C to stop"
echo java -classpath $CLASSPATH jist.runtime.Main jist.swans.Main  sensorApp.SensorNode 1>LogNormal.txt 2>LogErrors.txt
java -classpath $CLASSPATH jist.runtime.Main jist.swans.Main  sensorApp.SensorNode 
