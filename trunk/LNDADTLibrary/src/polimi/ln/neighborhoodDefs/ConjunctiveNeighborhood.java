 ...
 * *
 * *    $Id: ConjunctiveNeighborhood.java 118 2008-05-28 17:35:12Z lmottola $
 * *
...
/**
 * Defines a Logical Neighborhood based on a conjunction of atomic predicates. A
 ...
 * 
 */
public class ConjunctiveNeighborhood implements Serializable, Neighborhood {
	...
	/**
	 * Defines a neighborhoods based on the conjunction of predicates given as
	 * parameters.
	 * 
	 * @param preds
	 *            the predicates making up the conjunction.
	 */
	public ConjunctiveNeighborhood(AtomicPredicate[] preds) {
	 ...
	 *            the predicates.
	 */
	public ConjunctiveNeighborhood(AtomicPredicate[] preds, byte maxHops) {
	...
	public String toString() {
		...
		String ret = new String("Conjunctive Neighborhood composed of "
